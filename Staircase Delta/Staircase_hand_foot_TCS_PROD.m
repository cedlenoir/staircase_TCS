...
while ok==1;
        ...
        while response_ok==0
            ...
            switch a
                case '1'
                    ...
                    temp_hand1(end+1)=temp_hand;
                    temp_foot1(end+1)=temp_foot;
                case '2'
                    response_ok=1;
        ...
        while response_ok==0;
            ...
            switch a
                case '1'
                    ...
                    temp_hand2(end+1)=temp_hand;
                    temp_foot2(end+1)=temp_foot;
                case '2'
                    response_ok=1;
    ...
    result.temp_hand1=temp_hand1;
    result.temp_hand2=temp_hand2;
    result.temp_foot1=temp_foot1;
    result.temp_foot2=temp_foot2;
...
result.hand_foot_threshold=mean(c(3:requested_reversals));

[a,b]=find(result.reversals_foot_hand==1);
c=result.delta_temp_foot_hand(b);
result.foot_hand_threshold=mean(c(3:requested_reversals));

result.threshold=(result.foot_hand_threshold+result.hand_foot_threshold)/2;
